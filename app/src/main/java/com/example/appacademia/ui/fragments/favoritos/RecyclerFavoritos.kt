...
class RecyclerFavoritos(private val cursos: List<Curso>, private val listener : OnItemClickListener, private val checkedChangeListener: OnItemCheckedChangeListener, private val username : String) : RecyclerView.Adapter<RecyclerFavoritos.ViewHolder>() {
    /***
    ...
    interface OnItemClickListener {
         ...
         * @param curso - curso correspondiente a la tarjeta seleccionada
         */
        fun onButtonClick2(curso: Curso)
    }
     ...
     * @param viewType
     */
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerFavoritos.ViewHolder {
        val row: View = LayoutInflater.from(parent.context).inflate(R.layout.tarjetas_horizontal, parent, false)
        return ViewHolder(row)
    }

    /**
     * Obtener la cantidad de cursos marcados
     ...
     */
    override fun onBindViewHolder(holder: RecyclerFavoritos.ViewHolder, position: Int) {
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val tipoAcademia: TextView = view.findViewById(R.id.nombreAcademia)
        ...
        fun bindRow(curso: Curso) {
            ...
            GlobalScope.launch {
                ...
                Log.i("albaricoques", favorito.toString())
            ...
            botonInscribirse.setOnClickListener{listener.onButtonClick2(curso)}
